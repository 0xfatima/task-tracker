    ...
    const updateTodoChecklist = async (index) =>{
      ...
      if(todoChecklist && todoChecklist[index]){
        ...
        try{
          ...
          todoChecklist[index].completed = ! todoChecklist[index]
        }
      }
    }
...
return <>
<label htmlFor="" className='text-xs font-medium text-slate-500'>{label}</label>
<p className='text-[12px] md:text-[13px] font-medium text-grey-700 mt-0.5'>{value}</p>
</>
}
